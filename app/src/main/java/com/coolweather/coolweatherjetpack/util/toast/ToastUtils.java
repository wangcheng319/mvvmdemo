package com.coolweather.coolweatherjetpack.util.toast;
...
import com.coolweather.coolweatherjetpack.util.toast.style.ToastAntpoolStyle;
...
public final class ToastUtils {
    ...
    private static void checkToastState() {
        ...
        if (sToast == null) {
            init(CoolWeatherApplication.Companion.getApplication());
